<section>
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-3xl font-bold tracking-tight">{{ __('Edit Role') }}</h1>
                <p class="mt-2 text-sm text-neutral-600 dark:text-neutral-400">
                    {{ __('Update role information') }}
                </p>
            </div>
            <flux:button href="{{ route('rbac.role.show', $role) }}" variant="ghost" icon="arrow-left" wire:navigate>
                {{ __('Back') }}
            </flux:button>
        </div>
                ...
                <flux:card>
                    <form wire:submit="save" class="space-y-6">
                        ...
                        <div class="flex gap-2 pt-4">
                            ...
                            <flux:button href="{{ route('rbac.role.show', $role) }}" variant="ghost" wire:navigate>
                                {{ __('Cancel') }}
                            </flux:button>
                        </div>
                    </form>
