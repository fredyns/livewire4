<section>
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-3xl font-bold tracking-tight">{{ __('Permissions') }}</h1>
                <p class="mt-2 text-sm text-neutral-600 dark:text-neutral-400">
                    {{ __('Manage system permissions') }}
                </p>
            </div>
            <flux:button href="{{ route('rbac.permission.create') }}" icon="plus" wire:navigate>
                            ...
                            <flux:table.cell align="end" style="padding-right: 12px !important;">
                                <div class="flex items-center justify-end gap-2">
                                    <flux:dropdown>
                                        ...
                                        <flux:menu>
                                            <flux:menu.item
                                                href="{{ route('rbac.permission.show', $permission) }}"
                                                icon="eye"
                                                wire:navigate
                                            >
                                                {{ __('View') }}
                                            ...
                                            <flux:menu.item
                                                href="{{ route('rbac.permission.edit', $permission) }}"
                                                icon="pencil"
                                                wire:navigate
                                            >
                                                {{ __('Edit') }}
