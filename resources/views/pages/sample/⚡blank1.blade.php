...
<div>
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="sticky z-10 -mx-6 px-6 h-12 flex items-center gap-3 bg-white/95 dark:bg-zinc-900/95 backdrop-blur border-b border-zinc-200 dark:border-white/10" style="top: 4.5rem; margin-top: -2.5rem;">
