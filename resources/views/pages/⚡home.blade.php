...
<div>
    ...
    <section class="pt-10 pb-20">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#services"
                   class="px-8 py-4 text-lg font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors shadow-lg hover:shadow-xl">
                    Explore Services
                </a>
                <a href="#contact"
                   class="px-8 py-4 text-lg font-semibold text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-zinc-800 hover:bg-gray-200 dark:hover:bg-zinc-700 rounded-lg transition-colors">
                    Contact Us
                </a>
            </div>
        </div>
    ...
    <section id="services" class="py-20 bg-gray-50 dark:bg-zinc-800/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 dark:text-gray-400">Comprehensive IT solutions tailored to your
                    needs</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Service 1 -->
                <div
                    class="bg-white dark:bg-zinc-900 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-shadow border border-gray-200 dark:border-zinc-800">
                    <div
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Scalable cloud infrastructure and migration services to
                        modernize your operations</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Protect your business with advanced security solutions
                ...
                <div
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Custom software solutions built with modern technologies
                ...
                <div
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Strategic technology consulting to optimize your IT
                        infrastructure</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Efficient data storage, backup, and recovery solutions
                ...
                <div
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Round-the-clock technical support to keep your business
                        running smoothly</p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 dark:text-gray-400">Industry-leading expertise and commitment to
                    excellence</p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                @auth
                    <a href="{{ url('/dashboard') }}"
                       class="px-8 py-4 text-lg font-semibold text-blue-600 bg-white hover:bg-gray-100 rounded-lg transition-colors shadow-lg">
                        Go to Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}"
                ...
                <a href="mailto:info@itservices.com"
                   class="px-8 py-4 text-lg font-semibold text-white bg-transparent border-2 border-white hover:bg-white hover:text-blue-600 rounded-lg transition-colors">
                    Contact Sales
                </a>
            </div>
        </div>
    ...
    <!-- Footer -->
    <footer class="bg-gray-900 dark:bg-black text-gray-400 py-12 rounded-xl">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
