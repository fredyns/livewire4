...
```php
<?phpuse Livewire\Component;new class extends Component{    public $count = 0;    public function increment()    {        $this->count++;    }};?><div>    <h1 class="title">Count: {{ $count }}</h1>    <button class="btn" wire:click="increment">+</button></div><style>    .title {        color: blue;        font-size: 2rem;    }    .btn {        background: indigo;        color: white;        padding: 0.5rem 1rem;        border-radius: 0.25rem;    }</style>
...
```text
resources/views/components/counter/Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ counter.phpÃ¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ counter.blade.phpÃ¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ counter.css 
...
```css
/* What you write */.btn { background: blue; }/* What gets served */[wire\:name="counter"] {  .btn { background: blue; }}
...
Sometimes you need styles that apply globally rather than being scoped to a single component.
...
Add the `global` attribute to your style tag:
...
```text
resources/views/components/counter/Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ counter.phpÃ¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ counter.blade.phpÃ¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ counter.css 

# Scoped stylesÃ¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ counter.global.css 
...
```php
<?phpuse Livewire\Component;new class extends Component{    // ...};?><div class="counter">    <h1 class="title">My Counter</h1></div><style>    .title { color: blue; }</style><style global>    .counter-page-layout { display: grid; place-items: center; }</style>
...
- Styling is specific to a single component- You want to avoid CSS class name collisions- You're building reusable, self-contained componentsUse global styles when:- You need to style elements outside your component- You're defining utility classes used across multiple components- You're overriding third-party library stylesUse `@assets` for external stylesheets:
