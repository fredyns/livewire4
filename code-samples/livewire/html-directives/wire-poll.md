...
**Source URL:** https://livewire.laravel.com/docs/4.x/wire-poll
...
If a component using `wire:poll.visible` is at the bottom of a long page, it won't start polling until the user scrolls it into the viewport. When the user scrolls away, it will stop polling again.
...
- [Loading States](../features/loading-states.md) — Show feedback while loading
