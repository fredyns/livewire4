...
**Source URL:** https://livewire.laravel.com/docs/4.x/wire-transition
...
**Note:** Firefox 144+ supports basic view transitions, but does not support transition types.

## Reference

**Syntax:** `wire:transition="name"`
...
- [Alpine](../features/alpine.md) — For more complex animation needs
