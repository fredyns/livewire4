...
**Source URL:** https://livewire.laravel.com/docs/4.x/directive-placeholder
...
**Note:** The `@placeholder` directive works for single-file and multi-file components. For class-based components, use the `placeholder()` method instead.

**Important:** The placeholder and component must share the same root element type. If your placeholder uses `<div>`, your component must also use `<div>`.
