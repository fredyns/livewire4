...
**Source URL:** https://livewire.laravel.com/docs/4.x/attribute-async
...
**Async actions and state mutations don't mix.** Never use async actions if they modify component state that's reflected in your UI. Because async actions run in parallel, you can end up with unpredictable race conditions where your component's state diverges across multiple simultaneous requests.
...
- [Events](../essentials/events.md) — Dispatch and listen for events
