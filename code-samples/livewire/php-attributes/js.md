...
**Source URL:** https://livewire.laravel.com/docs/4.x/attribute-js
...
- [JavaScript](../advanced/javascript.md) — JavaScript integration in Livewire
- [Alpine](../features/alpine.md) — Client-side interactivity
