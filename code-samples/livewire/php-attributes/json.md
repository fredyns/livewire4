...
**Source URL:** https://livewire.laravel.com/docs/4.x/attribute-json
...
**Note:** Validation errors from JSON methods are only returned via promise rejection. They don't appear in `$wire.$errors` or the component's error bag. This is intentional—JSON methods are self-contained and don't affect the component's rendered state.
...
- [Async](./async.md) — Run actions in parallel without blocking
