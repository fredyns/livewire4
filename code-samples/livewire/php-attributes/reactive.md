...
**Source URL:** https://livewire.laravel.com/docs/4.x/attribute-reactive
...
**Use reactive properties sparingly.** Reactive properties require additional data to be sent between server and client on every parent update. Only use `#[Reactive]` when necessary for your use case.
