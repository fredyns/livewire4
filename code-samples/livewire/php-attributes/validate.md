...
**Source URL:** https://livewire.laravel.com/docs/4.x/attribute-validate
...
**Rule objects not supported:** PHP attributes can't use Laravel's Rule objects directly. For complex rules like `Rule::exists()`, use a `rules()` method instead:
...
- [Validation](../features/validation.md) — Complete guide to validation
