...
**Source URL:** https://alpinejs.dev/essentials/state
...
You can register a store using `Alpine.store()`, and reference one with the magic `$store` property.
...
- [Templating](./templating.md) — Using data in templates
