...
**Source URL:** https://alpinejs.dev/essentials/events
...
Let's say you wanted to listen for the enter key to be pressed inside an `<input>` element. Alpine makes this easy by adding the `.enter` modifier like so:
