...
**Source URL:** https://alpinejs.dev/directives/cloak
...
If you'd like to achieve this same behavior, but avoid having to include a global style, you can use the following trick:
...
- [Templating](../essentials/templating.md) — Preventing page flicker
