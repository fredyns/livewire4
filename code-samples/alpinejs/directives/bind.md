...
**Source URL:** https://alpinejs.dev/directives/bind
...
> **Note:** `x-bind` cannot be used if no parent element has `x-data` defined.
...
- [Templating](../essentials/templating.md) — Binding attributes
