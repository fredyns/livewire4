...
**Source URL:** https://alpinejs.dev/directives/if
...
- [x-show](./show.md) — Toggle visibility with CSS
- [Templating](../essentials/templating.md) — Toggling elements
- [x-transition](./transition.md) — Smooth transitions
