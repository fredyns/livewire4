...
**Source URL:** https://alpinejs.dev/advanced/reactivity
...
`Alpine.reactive` is only the first half of the story. `Alpine.effect` is the other half.
...
## Example: Counter Without Alpine Syntax
...
This combination unlocks an incredibly powerful programming paradigm for web development.
...
- [Alpine.reactive()](../globals/reactive.md) — Create reactive data
- [Alpine.effect()](../globals/effect.md) — Create reactive effects
